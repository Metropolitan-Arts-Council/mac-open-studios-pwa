...
<!--            <p><img style="height: 18px; width: auto; vertical-align: middle" src="/static/icons/preview-filter.png" alt="Preview Day" /> *Saturday, November 6 (select artists only): 10:00 a.m. - 6:00 p.m.</p>-->
            ...
            <p class="web-with-icon"><a href="http://greenvilleopenstudios.com">greenvilleopenstudios.com</a></p>
            <p class="facebook-with-icon"><a href="https://www.facebook.com/macartscouncil/">Facebook</a></p>
            <p class="instagram-with-icon"><a href="https://www.instagram.com/macartscouncil/?hl=en">Instagram</a></p>
            <p class="twitter-with-icon"><a href="https://twitter.com/MACartscouncil?lang=en">Twitter</a></p>
            <p class="youtube-with-icon"><a href="https://www.youtube.com/channel/UC_IlUGDWz_o89-oD80xMM-w">YouTube</a></p>
